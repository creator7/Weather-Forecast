...
/**
 * Created by Abdullah on 12/12/2016.
 */

public class WeatherContract {

    public static final String CONTENT_AUTHORITY = "com.example.abdullah.weatherapp";
    ...
    public static final class WeatherEntry implements BaseColumns {
        ...
        public static String getSqlSelectForTodayOnwards() {
            long normalizedUtcNow = MyDateUtils.normalizeDate(System.currentTimeMillis());
