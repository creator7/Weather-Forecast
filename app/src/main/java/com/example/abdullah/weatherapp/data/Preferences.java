...
import com.example.abdullah.weatherapp.R;
...
//
//    public static void setPrefCity(Context context,String cityName){
//        SharedPreferences sp = PreferenceManager.getDefaultSharedPreferences(context);
//        SharedPreferences.Editor editor = sp.edit();
//
//        editor.putString(PREF_LOCATION, cityName);
//        editor.apply();
//    }
...
//    }
    ...
    public static void setDefaultLocation(Context context, GPSTracker gpsTracker){

        if (gpsTracker.canGetLocation())
        {
            DecimalFormat df = new DecimalFormat("#.####");
            df.setRoundingMode(RoundingMode.CEILING);
            Double longitude = Double.valueOf(df.format(gpsTracker.getLongitude()));
            Double latitude = Double.valueOf(df.format(gpsTracker.getLatitude()));
