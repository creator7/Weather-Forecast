...
import com.example.abdullah.weatherapp.DetailActivity;
...
/**
 * Created by abdul on 12/24/2016.
 */
...
public class NotificationUtils {
    ...
    public static void notifyUserOfNewWeather(Context context){
            Uri todayWeatherUri = WeatherContract.WeatherEntry.buildWeatherUriWithDate(MyDateUtils.normalizeDate(System.currentTimeMillis()));
